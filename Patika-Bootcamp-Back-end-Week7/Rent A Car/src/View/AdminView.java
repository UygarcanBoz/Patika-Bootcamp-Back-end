...
public class AdminView extends Layout {
    ...
    public void loadModelTable(ArrayList<Object[]> modelList) {
        /*
        guiden jtable oluşturduk
        kendimiz defaulttable oluşturduk
        tek boyutlu array oluşturduk, table sütun isimlerini tutmak için
        db'ye bağlanıp ilgili tablodaki tüm satırları arraylist'e çekmek
        defaulttable'a setlemek için satırların Object[] 'e dönüşüm
        defaulttable'a satırların setlenecek
         */
